"""
Django settings for gowius project.
...
SECRET_KEY = '5$bubu)x7p20942uimd-f%^2%hqa3q@^qnh8*nn2i)srx3w!=)'
...
WSGI_APPLICATION = 'gowius.wsgi.application'
